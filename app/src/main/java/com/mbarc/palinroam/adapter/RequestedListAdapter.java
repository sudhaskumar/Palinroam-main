 ...
 */
public class RequestedListAdapter extends RecyclerView.Adapter<FriendDetailViewHolder> {
    Context context;
    List<FriendsData> friendDataList = Collections.emptyList();

    public RequestedListAdapter(Context context, List<FriendsData> friendDataList) {
    ...
    public FriendDetailViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.singleitem_of_requested_friends_list, parent, false);
